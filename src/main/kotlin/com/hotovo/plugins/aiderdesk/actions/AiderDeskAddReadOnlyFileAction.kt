...
class AiderDeskAddReadOnlyFileAction : AnAction() {

    private val LOG = Logger.getInstance(AiderDeskAddReadOnlyFileAction::class.java)
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (filesToProcess.isEmpty()) {
            LOG.warn("AiderDeskAddFileAction performed but no valid files or directories were found. This might indicate an issue if the action was enabled.")
            return
        }
        ...
        for (virtualFile in filesToProcess) {
            ...
            LOG.info("AiderDesk: AddReadOnlyFile action performed for $entryType: ${virtualFile.path}")
        }
    }
}
