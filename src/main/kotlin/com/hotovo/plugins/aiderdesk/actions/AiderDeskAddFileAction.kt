...
class AiderDeskAddFileAction : AnAction() {

    private val LOG = Logger.getInstance(AiderDeskAddFileAction::class.java)
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        for (virtualFile in filesToProcess) {
            ...
            LOG.info("AiderDesk: AddFile action performed for $entryType: ${virtualFile.path}")
        }
    }
}
